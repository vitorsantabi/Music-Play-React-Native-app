...
import { allToveLoSongs, Song } from "@/data/toveloDataMusic";

const bgImage = require("@/images/bgTovelo.jpg");
const sunshinekitty = require("@/images/tovelo/sunshinekitty.avif");
const dirtfemme = require("@/images/tovelo/dirty.avif");
...
const ToveLo = () => {
  ...
  const getAlbumImage = (albumName: string) => {
    switch (albumName) { case "Sunshine Kitty": return sunshinekitty; case "Dirt Femme": return dirtfemme; default: return bgImage; }
  };
        ...
        <SafeAreaView style={styles.safeArea}>
          ...
          <ScrollView contentContainerStyle={[styles.scrollContent, currentSong && { paddingBottom: 100 }]} showsVerticalScrollIndicator={false}>
            ...
            <Animated.View style={[styles.section, { opacity: contentOpacity, transform: [{ translateY: contentTranslate }] }]}>
              ...
              <View style={styles.bioContainer}>
                <Text style={styles.bioText}>Tove Lo é uma cantora e compositora sueca conhecida por seu pop dark e introspectivo. Com letras cruas e honestas sobre amor, festas e vulnerabilidade, ela construiu uma carreira que equilibra hits dançantes com profundidade emocional autêntica.</Text>
              </View>
            </Animated.View>
            ...
            <Animated.View style={[styles.section, { opacity: contentOpacity, transform: [{ translateY: contentTranslate }] }]}>
              ...
              <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.albumsList}>
                <MediaItem imageUri={sunshinekitty} title="Sunshine Kitty" sub="2019 • Álbum" linkHref="/play/sunshinekitty" variant="album" />
                <MediaItem imageUri={dirtfemme} title="Dirt Femme" sub="2022 • Álbum" linkHref="/play/dirtfemme" variant="album" />
              </ScrollView>
            </Animated.View>
          </ScrollView>
          ...
          {currentSong && (
            <BlurView intensity={90} tint="dark" style={styles.miniPlayer}>
              ...
              <LinearGradient colors={["#14B8A6", "#0D9488"]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={[styles.progressFill, { width: isPlaying ? "100%" : "0%" }]} />
            </BlurView>
          )}
        </SafeAreaView>
      </ImageBackground>
